      ...
      <div className="container mx-auto flex flex-col items-center gap-12">
        ...
        <div className="relative w-full max-w-[1104px] h-[730px] rounded-tl-3xl overflow-hidden">
          ...
          <div className="hidden md:block absolute right-0 top-0 w-[523px]">
            ...
            {/* Card 3 - Teacher feedback (Blue) */}
            <div className="absolute top-52 right-0 w-full bg-[#A6D3E1] rounded-tr-3xl p-10 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-text-strong opacity-70 text-base leading-relaxed max-w-[413px]">
                  Highly-qualified teachers make sure your employees learn English quickly. They get the feedback they need to speak English with confidence.
                  <br />
                  Learners attend small classes with a maximum of three other adult learners at exactly the same level. Our teachers will validate and confirm what they&apos;ve learned. We&apos;ll make sure your staff improve their English language skills effectively.
                </p>
              </div>
          ...
          <div className="md:hidden absolute bottom-0 left-0 right-0 flex flex-col gap-4 p-4">
            ...
            <div className="bg-[#A6D3E1] rounded-lg p-6 flex flex-col gap-4">
              ...
              <p className="text-text-strong opacity-70 text-sm">
                Get expert guidance from qualified teachers with constant feedback.
              </p>
              <Button variant="primary" className="self-start">
                Start Learning
              </Button>
